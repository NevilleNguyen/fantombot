...
type GraphqlAltClient struct {
	l      *zap.SugaredLogger
	client *graphql.Client
}

func NewGraphqlAltClient() (*GraphqlAltClient, error) {
	l := zap.S()
	...
	return &GraphqlAltClient{
		l:      l,
		client: client,
	}, nil
}

func (c *GraphqlAltClient) GetListValidators(parentCtx context.Context) ([]pkg.SFCValidator, error) {
...
func (c *GraphqlAltClient) GetListFTMTransferByBlock(parentCtx context.Context, blockNumber uint64) ([]pkg.TransferLog, error) {
